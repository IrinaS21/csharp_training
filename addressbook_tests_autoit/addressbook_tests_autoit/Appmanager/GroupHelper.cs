...
namespace addressbook_tests_autoit
{
    public class GroupHelper : HelperBase
    {
        ...
        public static string REMOVEGROUPWINTITLE = "Delete group";
        ...
        {
            OpenGroupsDialogue();
            aux.ControlTreeView(GROUPWINTITLE, "", "WindowsForms10.SysTreeView32.app.0.2c908d51", "Select", "#0|#" + toBeRemoved.Id, "");
            aux.ControlClick(GROUPWINTITLE, "", "WindowsForms10.BUTTON.app.0.2c908d51");
            aux.WinWait(REMOVEGROUPWINTITLE);
            aux.ControlClick(REMOVEGROUPWINTITLE, "", "WindowsForms10.BUTTON.app.0.2c908d53");
